...
class _LoginScreen3State extends State<LoginScreen3> with TickerProviderStateMixin {
  ...
  final Color primary = Colors.white;//Colors.grey[400];
  final Color secondary = Colors.redAccent;//Colors.white;
  ...
  final TextEditingController signInEmailcontroller = new TextEditingController();
  final TextEditingController signInPasswordcontroller = new TextEditingController();
              ...
              children: <Widget>[
                new Expanded(
                  child: new OutlineButton(
                    ...
                    color: secondary, // TODO is sichtbar
              ...
              children: <Widget>[
                new Expanded(
                  child: new FlatButton(
                    ...
                    color: secondary,
                    onPressed: () async {
                      String emailorname = signInEmailcontroller.text;
                      String pw = signInPasswordcontroller.text;
                      if(EmailValidator.validate(emailorname)) {
                        setState(() => loading = true);
                        dynamic result = await _auth.signInEmailAndPassword(emailorname, pw);
                        if(result == null) {
                        ...
                        setState(() => loading = true);
                        dynamic result = await _auth.signInEmailAndPassword('${emailorname}@username.com', pw);
                        if(result == null) {
                          setState(() => loading = false);
                          // TODO display error
                        }
              ...
              children: <Widget>[
                new Expanded(
                  child: new FlatButton(
                    ...
                    color: secondary,
                    onPressed: () async {
                      String emailorname = signUpEmailcontroller.text;
                      String pw = signUpPasswordcontroller.text;
                      String confpw = signUpConfirmPasswordcontroller.text;
                      if(pw == confpw) {
                        if(EmailValidator.validate(emailorname)) {
                          setState(() => loading = true);
                          dynamic result = _auth.signUpEmailAndPassword(emailorname, pw);
                          if(result == null) {
                            // TODO display error
                            setState(() => loading = false);
                          }
                          ...
                          setState(() => loading = true);
                          dynamic result = await _auth.signUpEmailAndPassword('${emailorname}@username.com', pw);
                          if(result == null) {
                            // TODO display error
                            setState(() => loading = false);
                          }
  ...
  Widget build(BuildContext context) {
    return loading ? Loading(primary, secondary) : Container(
        height: MediaQuery.of(context).size.height,
        child: PageView(

...
/// Overrides the original CupertinoButton with _kBackgroundButtonPadding set to vertical: 0 and horizontal: 0
...
class CupertinoButtonSmall extends StatefulWidget {
  /// Creates an iOS-style button.
  const CupertinoButtonSmall({
    Key key,
    @required this.child,
    this.padding,
    this.color,
  ...
  /// default constructor.
  const CupertinoButtonSmall.filled({
    Key key,
    @required this.child,
    this.padding,
    this.disabledColor = CupertinoColors.quaternarySystemFill,
  ...
  @override
  _CupertinoButtonSmallState createState() => _CupertinoButtonSmallState();
...
class _CupertinoButtonSmallState extends State<CupertinoButtonSmall> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(CupertinoButtonSmall old) {
